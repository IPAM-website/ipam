            ...
            <div class="p-4">
                <div class="flex items-center gap-2 mb-3">
                    <svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 17v-2a4 4 0 014-4h2a4 4 0 014 4v2M7 17v-2a4 4 0 014-4h2a4 4 0 014 4v2" />
                    </svg>
                    <p class="text-gray-700 text-sm">
                        Il file <span class="font-semibold text-cyan-700">CSV</span> deve avere le seguenti colonne (intestazioni nella prima riga):
                    </p>
                </div>
                        ...
                        <thead>
                            <tr>
                                {CSVInfoDBTableMaps[tableName].keys.map((col) => (
                                    <th key={col} class="px-3 py-2 bg-cyan-50 text-cyan-800 font-semibold border-b border-gray-200">
                                        {col}
                                    </th>
                                ))}
                        ...
                        <tbody class="text-center">
                            <tr class="even:bg-gray-50">
                                {CSVInfoDBTableMaps[tableName].example?.map((col) => (
                                    <td key={col} class="px-3 py-2 border-b border-gray-100">
                                        {col}
                                    </td>
                                ))}
                            </tr>
                ...
                <div class="flex items-center gap-2 mt-5 bg-cyan-50 border-l-4 border-cyan-400 px-4 py-2 rounded">
                    <svg class="w-5 h-5 text-cyan-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M12 2a10 10 0 100 20 10 10 0 000-20z" />
                    </svg>
                    <span class="text-cyan-800 text-sm">
                        Assicurati che le intestazioni siano esattamente come sopra e che ogni riga contenga i dati corrispondenti.
                    </span>
                </div>
            </div>
        </>
