...
export default component$<ButtonProps>(({ nomePulsante, onClick$ }) => {
    return (
        <div class="w-7/10 h-9 px-4 mb-8 bg-black max-w-[300px] rounded-lg flex justify-center items-center m-4 cursor-pointer hover:w-4/5 hover:max-w-[360px] transition-all duration-200 ease-in" onClick$={onClick$}>
