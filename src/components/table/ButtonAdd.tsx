...
export default component$<ButtonProps>(({ nomePulsante, onClick$ }) => {
    return (
        <div class="w-96 h-9 px-4 bg-black rounded-lg inline-flex justify-center items-center gap-2 m-4 cursor-pointer hover:w-[400px] transition-all duration-200 ease-in" onClick$={onClick$}>
