    ...
    return (
        <>
            ...
            <div class="flex flex-col gap-2 md:flex-row">
                <div class="md:w-1/4 md:h-[60vh] mx-5 flex flex-col shadow p-2 md:p-3 rounded-md border border-gray-200">
                    <div class="flex items-center gap-2 ms-1" onClick$={() => {
                        ...
                        <p class="font-medium w-full  flex justify-between text-sm py-2 pe-2">
                            {$localize`Location`}
                    ...
                    {seeLocMobile.value && <hr class="text-gray-300 mb-2" />}
                    <div class="space-y-1  max-md:max-h-[500px] transition-all " style={{ maxHeight: seeLocMobile.value ? 500 : 0, overflowY: seeLocMobile.value ? "auto" : "hidden" }}>
                        {
                ...
                <div class="md:w-3/4 md:h-[60vh] mx-5 flex flex-col shadow p-3 rounded-md border border-gray-200">
                    <div class="flex items-center gap-2 ms-1" onClick$={() => {
                        ...
                        <p class="font-medium flex justify-between items-center text-sm w-full py-2">
                    ...
                    {seeSiteMobile.value && <hr class="text-gray-300 mb-2" />}
                    <div class="transition-all max-sm:max-h-[500px] h-full" style={{ maxHeight: seeSiteMobile.value ? "60vh" : 0, overflowY: seeSiteMobile.value ? "hidden" : "auto" }}>
                        {selected.value !== -1 ? (
                            <div class="space-y-1 h-full overflow-x-hidden">
                                ...
                                {sites.value.length > 0 ? sites.value.map((x: SiteModel) => (
                                    <div class="flex items-center mx-2 justify-between">
                                        ...
                                        <a
                                            href={`${x.idsito}/`}
                                            class="gap-3 text-sm text-blue-600 hover:underline flex items-center"
                                        >
                                            {x.datacenter && x.tipologia == "active" && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-gray-700">
                                            ...
                                            {!x.datacenter && x.tipologia == "filiale" && <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5 text-gray-700">
                            ...
                            (!siteUpdateMode.value && <div class="w-full flex justify-center mt-3 items-center h-full text-gray-400 mb-3">
