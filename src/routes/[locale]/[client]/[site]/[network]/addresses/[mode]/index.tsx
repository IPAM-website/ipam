...
export const useAddresses = server$(async function (
  this,
  filter = { empty: 1 },
) {
...
export default component$(() => {
  ...
  const reloadData = $(async () => {
    if (filter.active) return await useAddresses(filter.params);
    else return await useAddresses();
  });
          ...
          <Table>
            <div class="mb-4 flex flex-col gap-2 rounded-t-xl border-b border-gray-200 bg-gray-50 px-4 py-3 md:flex-row md:items-center md:justify-between">
              <div class="flex items-center gap-2">
                <span class="text-lg font-semibold text-gray-800">{$localize`Lista indirizzi`}</span>
            ...
            <Dati
              DBTabella="indirizzi"
              title={$localize`Lista indirizzi IP`}
            ...
            <div class="flex">
              <ButtonAddLink
                nomePulsante={$localize`Aggiungi indirizzo`}
      ...
      <>
        ...
        >
          <FormBox title="Informazioni">
            ...
            <TextboxForm
              id="txtName"
              title={$localize`Nome Dispositivo`}
            ...
            <TextboxForm
              id="txtModel"
              title={$localize`Marca Dispositivo`}
            ...
            <DatePicker
              id="dpData"
              name={$localize`Data inserimento`}
          ...
          <FormBox title="Dettagli">
            ...
            {attempted.value &&
              ...
              !formData.ip && (
                <span class="text-red-600">{$localize`This IP Address is invalid`}</span>
              )}
            ...
            >
              {changeIP.value ? (
                <div class="has-tooltip relative">
                  ...
                  <span class="tooltip">{$localize`Remove`}</span>{" "}
                </div>
              ) : (
                <div class="has-tooltip relative">
                  <svg
                  ...
                  <span class="tooltip">{$localize`Change IP`}</span>{" "}
                </div>
              )}
            </button>
          )}
