          ...
          <div class="flex flex-col gap-4 md:flex-row">
            <div class="mt-4 inline-flex flex-1 flex-col items-start justify-start gap-1 rounded-md border-1 border-gray-300 px-5 py-3 shadow-md">
              <div class="flex h-[50px] w-full items-center overflow-hidden">
                <div class="text-lg font-semibold text-black">{$localize`Informazioni sulla rete`}</div>
              </div>
              <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                <div class="justify-start text-lg font-normal text-black">{$localize`IP`}</div>
                <div class="justify-start text-lg font-normal text-black">
                  {network.value.iprete}
                </div>
              </div>
              <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                <div class="justify-start text-lg font-normal text-black">{$localize`Prefisso`}</div>
                <div class="justify-start text-lg font-normal text-black">
                  {network.value.prefissorete}
                </div>
              </div>
              <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                <div class="justify-start text-lg font-normal text-black">{$localize`Total Allocation Space`}</div>
                <div class="justify-start text-lg font-normal text-black">
                  {totalSpace.value}
                </div>
              </div>
              <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                <div class="justify-start text-lg font-normal text-black">{$localize`Allocated Space`}</div>
                <div class="justify-start text-lg font-normal text-black">
                  {allocatedSpace.value}
                </div>
              </div>
              <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                <div class="justify-start text-lg font-normal text-black">{$localize`Remaining Allocation Space`}</div>
                <div class="justify-start text-lg font-normal text-black">
            ...
            <div class="mt-4 inline-flex flex-1 flex-col items-start justify-start gap-1 rounded-md border-1 border-gray-300 px-5 py-3 shadow-md">
              <div class="flex h-[50px] w-full items-center overflow-hidden">
                <div class="text-lg font-semibold text-black">{$localize`Relatives components`}</div>
              </div>
              {parentNetwork.value && (
                <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                  <div class="justify-start text-lg font-normal text-black">{$localize`Parent Network`}</div>
                  <div
              ...
              {childrenNetworks.value && childrenNetworks.value.length > 0 && (
                <div class="inline-flex w-full items-center justify-between overflow-hidden border-t border-gray-300 px-2 py-2.5">
                  <div class="justify-start text-lg font-normal text-black">{$localize`Childrens`}</div>
                  <div class="justify-start text-lg font-normal text-black">
