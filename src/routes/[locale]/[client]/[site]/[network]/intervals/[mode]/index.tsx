        ...
        <div>
          ...
          <Table>
            <Dati
              ...
              title={$localize`Lista intervalli`}
            ...
            <div class="flex">
              <ButtonAddLink
                nomePulsante={$localize`Aggiungi intervallo`}
      ...
      <>
        ...
        >
          <FormBox title="Informazioni">
            <TextboxForm
              id="txtName"
              title={$localize`Nome Intervallo`}
            ...
            <TextboxForm
              id="txtModel"
              title={$localize`Descrizione Intervallo`}
          ...
          <FormBox title="Dettagli">
            ...
            <TextboxForm
              ...
              OnInput$={(e) => {
                ...
                let parsedIP = formData.iniziointervallo
                  .split(".")
                  .map((x) => parseInt(x));
            ...
            {attempted.value && !formData.lunghezzaintervallo && (
              <span class="text-red-600">{$localize`This length is invalid`}</span>
            )}
            ...
            {attempted.value && !formData.idrete && (
              <span class="text-red-600">{$localize`Please select a network`}</span>
            )}

            {alreadyOccupied.value && (
              <span class="text-red-600">{$localize`Space already occupied`}</span>
            )}
          </FormBox>
        </div>
